            ...
            while (!shuttingDown) {
                ...
                try {
                    ...
                    if (previousLatestMilestoneIndex != latestMilestoneIndex) {
                        ...
                        lastMilestoneLog = System.currentTimeMillis();
                    }
                    else
                    {
                    	if(System.currentTimeMillis() - lastMilestoneLog >= 300000)
                    	{
                    		log.info("Latest milestone has NOT changed! #" + latestMilestoneIndex);
                    		lastMilestoneLog = System.currentTimeMillis();
                    	}
                    }
